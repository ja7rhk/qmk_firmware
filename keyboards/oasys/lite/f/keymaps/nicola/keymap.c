...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_QWERTY] = LAYOUT(
      ...
      MO(_FUNC), KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     JP_COLN,  KC_ENT,    KC_DEL,   KC_HOME,  KC_INS,
   ...
   [_NICOLA] = LAYOUT(
      ...
      MO(_FUNC), NG_Q,     NG_W,     NG_E,     NG_R,     NG_T,     NG_Y,     NG_U,     NG_I,     NG_O,     NG_P,     NG_COLN,  KC_ENT,    KC_DEL,   KC_HOME,  KC_INS,
   ...
   [_FUNC] = LAYOUT(
       KC_LGUI,  KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   JP_CIRC,  JP_YEN,   KC_RALT,   _______,  _______,  _______,
       ...
       KC_NUM,             _______,            _______,                      _______,                      _______,
