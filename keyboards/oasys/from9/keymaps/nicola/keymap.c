...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_FUNC] = LAYOUT(
       KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   JP_YEN,   JP_CIRC,   _______,  _______,  _______,
       _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,  _______,  _______,  JP_LBRC,  JP_RBRC,  _______,   _______,  _______,  _______,
