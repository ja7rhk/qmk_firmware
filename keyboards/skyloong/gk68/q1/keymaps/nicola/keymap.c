...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NICOLA] = LAYOUT_all(
        KC_GRV,       NG_1,     NG_2,     NG_3,     NG_4,     NG_5,     NG_6,     NG_7,     NG_8,      NG_9,       NG_0,      NG_MINS,  NG_EQL,    KC_BSPC,    KC_ESC,
    ...
    [_FUNC] = LAYOUT_all(
        ...
        _______,      _______,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,  _______,   _______,    _______,   _______,  _______,   _______,    _______,
        ...
        KC_NUM,       _______,  _______,            KC_DEL,             _______,            KC_ESC,    _______,    _______,   _______,   _______,  _______,    _______
    )
