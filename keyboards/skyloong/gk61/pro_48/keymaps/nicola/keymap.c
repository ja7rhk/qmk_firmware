...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_all(
        ...
        KC_LCTL,      KC_LGUI,  KC_LALT,            KC_F14,   KC_SPC,      KC_F15,            KC_SPC,   KC_RALT,   KC_APP,    KC_RCTL,            MO(_FUNC)
    ),
    ...
    [_NICOLA] = LAYOUT_all(
        ...
        KC_LCTL,      KC_LGUI,  KC_LALT,            NG_SHFTL, KC_SPC,      KC_F15,            NG_SHFTR, KC_RALT,   KC_APP,    KC_RCTL,            MO(_FUNC)
    ),
    ...
    [_FUNC] = LAYOUT_all(
        ...
        _______,      _______,  _______,  _______,  _______,   _______,    _______,  _______,  _______,  KC_PGDN,   KC_UP,              _______,
        _______,      _______,  _______,            KC_TAB,    _______,    _______,            KC_F15,   KC_LEFT,   KC_DOWN,  KC_RIGHT,           _______
    )
};
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    ...
    switch (get_highest_layer(layer_state)) {
        ...
        case _FUNC:
            ...
            RGB_MATRIX_INDICATOR_SET_COLOR(L_PU_INDEX, 0, 0, 255); // function key : PU
            RGB_MATRIX_INDICATOR_SET_COLOR(GT_PD_INDEX, 0, 0, 255); // function key : PD
            break;
    }
    return false;
}
