...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_all(
        ...
        KC_LCTL,      KC_LGUI,  KC_LALT,            KC_F14,   _______,     KC_F15,            KC_SPC,   KC_RALT,   KC_APP,    KC_RCTL,            MO(_FUNC)
    ),
    ...
    [_NICOLA] = LAYOUT_all(
        ...
        KC_LCTL,      KC_LGUI,  KC_LALT,            NG_SHFTL, _______,     KC_F15,            NG_SHFTR, KC_RALT,   KC_APP,    KC_RCTL,            MO(_FUNC)
    ),
    ...
    [_FUNC] = LAYOUT_all(
        ...
        _______,      _______,  _______,            KC_DEL,    _______,    _______,            KC_SPC,   KC_LEFT,   KC_DOWN,  KC_RIGHT,           _______
    )
};
