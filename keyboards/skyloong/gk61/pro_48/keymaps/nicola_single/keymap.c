...
*/
    [_QWERTY] = LAYOUT_all(
        ...
        KC_LNG2,      KC_A,     KC_S,     KC_D,     KC_F,     KC_G,       KC_H,     KC_J,     KC_K,     KC_L,      KC_SCLN,  KC_QUOT,            KC_ENT,
        KC_LSFT,      KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,       KC_N,     KC_M,     KC_COMM,  KC_DOT,    KC_SLSH,            KC_UP,
        KC_LCTL,      KC_LGUI,  KC_LNG1,            _______,  KC_SPC,     _______,            _______,  MO(_FUNC), KC_LEFT,  KC_DOWN,            KC_RIGHT
    ),
    ...
    [_NICOLA] = LAYOUT_all(
        ...
        KC_LNG2,      NG_A,     NG_S,     NG_D,     NG_F,      NG_G,      NG_H,     NG_J,     NG_K,     NG_L,      NG_SCLN,  KC_BSPC,            KC_ENT,
        KC_LSFT,      NG_Z,     NG_X,     NG_C,     NG_V,      NG_B,      NG_N,     NG_M,     NG_COMM,  NG_DOT,    NG_SLSH,            KC_UP,
        KC_LCTL,      KC_LGUI,  NG_SHFTL,           _______,   NG_SHFTR,  _______,            _______,  MO(_FUNC), KC_LEFT,  KC_DOWN,            KC_RIGHT
    ),
    ...
    [_FUNC] = LAYOUT_all(
        ...
        KC_CAPS_LOCK, _______,  _______,  _______,  _______,   _______,   _______,  _______,  KC_HOME,  KC_PGUP,   _______,  _______,            _______,
        _______,      _______,  _______,  _______,  _______,   _______,   _______,  _______,  _______,  KC_PGDN,   _______,            KC_RSFT,
        _______,      _______,  KC_LALT,            _______,   KC_F15,    _______,            _______,  _______,   KC_RALT,  KC_APP,             KC_RCTL
    )
};
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    ...
    switch (get_highest_layer(layer_state)) {
        ...
        case _NICOLA:
            ...
            RGB_MATRIX_INDICATOR_SET_COLOR(OYA_LBRC_INDEX, 255, 255, 0); // 濁点 : on
            RGB_MATRIX_INDICATOR_SET_COLOR(OYA_RBRC_INDEX, 255, 255, 0); // 半濁点 : on
            RGB_MATRIX_INDICATOR_SET_COLOR(OYA_LALT_INDEX, 255, 255, 0); // IME On : on
            break;
        case _FUNC:
            if (is_capslock) {
                RGB_MATRIX_INDICATOR_SET_COLOR(CAPS_LOCK_INDEX, 255, 255, 255); // CapsLock : on
