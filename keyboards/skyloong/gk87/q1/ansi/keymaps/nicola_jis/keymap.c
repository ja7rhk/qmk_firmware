...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] =  LAYOUT_all(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,            KC_LNG1,  KC_SPC,                KC_SPC,               KC_RALT,    MO(_FUNC), KC_APP,             KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
    ),
     ...
     [_NICOLA] =  LAYOUT_all(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,            NG_SHFTL, _______,               NG_SHFTR,             KC_RALT,    MO(_FUNC), KC_APP,             KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
    ),
